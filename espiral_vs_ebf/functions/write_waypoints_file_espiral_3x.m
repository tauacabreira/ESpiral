function [final_waypoints] = ...
    write_waypoints_file_espiral02(file_name, waypoints, waypoints_info, home_coords, altitude)
    ...
    for i = 1 : max(waypoints_info) - 1
        ...
        x = [waypoints(index_ini,1) waypoints(index_ini,2); point(1) point(2)];
        ...
        if i == 1
            % just triplicating the waypoints
            for j = 1 : 3
